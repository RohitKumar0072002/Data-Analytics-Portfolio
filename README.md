# Data Analytics Portfolio – Rohit Kumar

Welcome to my Data Analytics Portfolio.

I have worked on multiple projects using SQL, Python (Pandas), Excel, and Power BI to analyze data, build dashboards, and generate business insights.
...
Built an interactive dashboard to track revenue trends and product performance.  
- Created KPIs like Total Revenue & Average Order Value  
...
Processed raw data using Pandas to make it analysis-ready.  
...
## Goal
To apply my data analytics skills in solving real-world business problems and contribute to data-driven decision-making.
